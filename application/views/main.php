                                            ...
                                            <table class="table table-striped">
                                                ...
                                                foreach($gallery_photos as $gallery_photo)
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <button data-p_ig_id="<?php echo $gallery_photo->p_g_id; ?>" class="photo-select-save select-remove is-button">Delete From Gallery</button> </td>
                                                        <td> <button data-p_ig_id="<?php echo $gallery_photo->p_g_id; ?>" class="photo-select-active select-<?php echo ($gallery_photo->p_active == 1) ? "inactive" : "active"; ?> is-button"><?php echo ($gallery_photo->p_active == 1) ? "Set Inactive" : "Set Active"; ?></button> </td>
